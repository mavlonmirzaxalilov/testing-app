      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Testni tanlang va bilimlaringizni sinab ko'ring</p>
          </div>
          ...
          {tests.length === 0 ? (
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">Admin tomonidan testlar qo'shilganda bu yerda ko'rinadi</p>
              </CardContent>
            </Card>
          ) : (
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <CardDescription className="text-base mb-3">{test.description}</CardDescription>
