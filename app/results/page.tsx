      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">O'tgan testlaringiz natijalarini ko'ring</p>
          </div>
          ...
          {results.length === 0 ? (
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">Test topshirganingizdan keyin natijalar bu yerda ko'rinadi</p>
              </CardContent>
            </Card>
          ) : (
                  ...
                  <Card key={`${result.testId}_${result.completedAt}`}>
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          <CardTitle>{test?.title || "Test topilmadi"}</CardTitle>
                          <CardDescription>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-4 gap-4 mb-4">
                        <div className="text-center">
                          ...
                          <div className="text-2xl font-bold text-green-500">{result.correctCount}</div>
                      ...
                      <div className="text-center text-sm text-muted-foreground">
                        Jami: {result.correctCount}/{totalQuestions} to'g'ri javob
                      </div>
                    </CardContent>
                  </Card>
                )
